...
/// Operator/driver: permissions, fused + LocationManager passes, stream fallbacks,
/// last-known when the OS misreports “location off”.
class LocationService {
  ...
  /// Does **not** bail out when location services are off — permission can be granted
  /// before the user turns GPS on; last-known may still work.
