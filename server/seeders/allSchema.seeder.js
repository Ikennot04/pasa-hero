...
export async function seedTerminalNotificationTimeline() {
  ...
  const notificationPayload = [
    ...
    makeTerminalEvent({
      ...
      bus: bus3,
      route: route03C,
      title: "CEB-003 Arrival Rejected at Bay 6",
      message:
        "Bay 6 was already occupied; CEB-003 arrival report could not be validated.",
    ...
    makeTerminalEvent({
      ...
      bus: bus11,
      route: route06F,
      title: "CEB-011 Arrived Full at Bay 5",
      message:
        "CEB-011 docked at Bay 5 with all seats occupied and standees onboard.",
      type: "full",
      minutes: 426,
      priority: "high",
    }),
    ...
    makeTerminalEvent({
      ...
      bus: bus11,
      route: route06F,
      title: "CEB-011 Departure Rejected at Bay 5",
      message:
        "Terminal operations rejected the CEB-011 departure report; gate clearance was not logged.",
    ...
    makeTerminalEvent({
      ...
      bus: bus1,
      route: route01A,
      title: "CEB-001 Skipped Stop Reported",
      message:
        "Bay marshal flagged CEB-001 for skipping the Capitol Site pickup before reaching Bay 2.",
      type: "skipped_stop",
      minutes: 391,
      priority: "medium",
    }),
    ...
    }),
    {
      ...
      terminal_id: String(smTerminal._id),
      title: "CEB-001 Boarding Announcement",
      message:
        "Final boarding call posted for Route 01A passengers at SM City Cebu Bay 2.",
      notification_type: "info",
      priority: "low",
      scope: "terminal",
      createdAt: minutesAgo(379),
    },
    makeTerminalEvent({
      sender: operator1,
      bus: bus2,
    ...
    makeTerminalEvent({
      ...
      bus: bus2,
      route: route03C,
      title: "Route 03C Corridor Clear",
      message:
        "Earlier congestion along Route 03C has cleared; normal headways resumed.",
      type: "route_free",
      minutes: 356,
      priority: "low",
    }),
    ...
    makeTerminalEvent({
      ...
      bus: bus4,
      route: route04D,
      title: "CEB-004 Arrival Rejected — Wrong Bay",
      message:
        "Bay 1 staff rejected CEB-004 docking report; bus pulled into the unscheduled lane.",
      type: "arrival_rejected",
      minutes: 318,
      priority: "high",
    }),
    ...
    makeTerminalEvent({
      ...
      bus: bus4,
      route: route04D,
      title: "CEB-004 Outbound Departing Full",
      message:
        "CEB-004 left Bay 1 at full standing capacity; next trip recommended for waiting passengers.",
      type: "full",
      minutes: 305,
      priority: "high",
    }),
    ...
    makeTerminalEvent({
      ...
      bus: bus9,
      route: route02B,
      title: "CEB-009 Skipped Stop on Inbound Leg",
      message:
        "CEB-009 was reported skipping the Talamban inbound stop before reaching Bay 3.",
      type: "skipped_stop",
      minutes: 280,
      priority: "medium",
    }),
    ...
    {
      sender_id: String(terminalAdmin1._id),
      bus_id: String(bus9._id),
      route_id: String(route02B._id),
      terminal_id: String(smTerminal._id),
      title: "Route 02B Operational Update",
      message:
        "Route 02B turnaround time updated to 35 minutes for the remainder of the shift.",
      notification_type: "info",
      priority: "low",
      scope: "terminal",
      createdAt: minutesAgo(268),
    },
    makeTerminalEvent({
      sender: operator1,
      bus: bus11,
    ...
    makeTerminalEvent({
      ...
      bus: bus11,
      route: route06F,
      title: "CEB-011 Departure Rejected (Second Trip)",
      message:
        "Second-trip CEB-011 departure report was rejected; safety inspection still pending at Bay 5.",
      type: "departure_rejected",
      minutes: 154,
      priority: "high",
    }),
    ...
    makeTerminalEvent({
      ...
      bus: bus3,
      route: route03C,
      title: "CEB-003 Evening Maintenance Note",
      message:
        "CEB-003 flagged for post-trip brake inspection after the evening Bay 6 docking.",
      type: "other",
      minutes: 91,
      priority: "medium",
    }),
    ...
    }),
    {
      ...
      route_id: String(route01A._id),
      terminal_id: String(smTerminal._id),
      title: "CEB-001 Last Trip Advisory",
      message:
        "CEB-001 final late-evening trip on Route 01A is the last available service tonight.",
      notification_type: "info",
      priority: "medium",
      scope: "terminal",
